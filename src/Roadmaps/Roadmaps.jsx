...
import { FaPython, FaJava, FaRobot, FaCloud, FaLayerGroup, FaChartLine } from 'react-icons/fa';
...
const Roadmaps = () => {
  ...
  const languages = [
    ...
    { name: 'AIML', icon: 'fas fa-robot' },
    { name: 'Cloud', icon: 'fas fa-cloud' },
    { name: 'Fullstack', icon: 'fas fa-layer-group' },
    { name: 'Data Analyst', icon: 'fas fa-chart-line' },
  ];

  // Roadmap nodes and edges
  const roadmaps = {
    'Data Analyst': [
      { id: '1', data: { label: 'Introduction to Data Analysis' }, position: { x: 250, y: 0 }, style: { background: '#0ea5e9', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { id: '2', data: { label: 'Excel & Spreadsheets' }, position: { x: 250, y: 100 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '3', data: { label: 'Statistics & Probability' }, position: { x: 250, y: 200 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '4', data: { label: 'Data Visualization (Tableau, Power BI)' }, position: { x: 250, y: 300 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '5', data: { label: 'SQL & Databases' }, position: { x: 250, y: 400 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '6', data: { label: 'Python/R for Data Analysis' }, position: { x: 250, y: 500 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '7', data: { label: 'Data Cleaning & Preprocessing' }, position: { x: 250, y: 600 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '8', data: { label: 'Exploratory Data Analysis (EDA)' }, position: { x: 250, y: 700 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '9', data: { label: 'Reporting & Storytelling' }, position: { x: 250, y: 800 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '10', data: { label: 'Projects: Dashboards, Reports' }, position: { x: 250, y: 900 }, style: { background: '#06b6d4', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
    ...
    AIML: [
      { id: '1', data: { label: 'Introduction to AI & ML' }, position: { x: 250, y: 0 }, style: { background: '#0ea5e9', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { id: '2', data: { label: 'Python for AIML' }, position: { x: 250, y: 100 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '3', data: { label: 'Maths for AIML (Linear Algebra, Stats)' }, position: { x: 250, y: 200 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '4', data: { label: 'Data Preprocessing' }, position: { x: 250, y: 300 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '5', data: { label: 'Supervised Learning' }, position: { x: 250, y: 400 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '6', data: { label: 'Unsupervised Learning' }, position: { x: 250, y: 500 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '7', data: { label: 'Model Evaluation' }, position: { x: 250, y: 600 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '8', data: { label: 'Deep Learning Basics' }, position: { x: 250, y: 700 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '9', data: { label: 'Neural Networks' }, position: { x: 250, y: 800 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '10', data: { label: 'NLP & Computer Vision' }, position: { x: 250, y: 900 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '11', data: { label: 'Libraries: scikit-learn, TensorFlow, PyTorch' }, position: { x: 250, y: 1000 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '12', data: { label: 'Projects: ML Apps, AI Bots' }, position: { x: 250, y: 1100 }, style: { background: '#06b6d4', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { source: '1', target: '2', animated: true, style: { stroke: '#22d3ee' } },
      { source: '2', target: '3', animated: true, style: { stroke: '#22d3ee' } },
      { source: '3', target: '4', animated: true, style: { stroke: '#22d3ee' } },
      { source: '4', target: '5', animated: true, style: { stroke: '#22d3ee' } },
    ...
    Cloud: [
      { id: '1', data: { label: 'Introduction to Cloud Computing' }, position: { x: 250, y: 0 }, style: { background: '#0ea5e9', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { id: '2', data: { label: 'Cloud Service Models (IaaS, PaaS, SaaS)' }, position: { x: 250, y: 100 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '3', data: { label: 'Deployment Models (Public, Private, Hybrid)' }, position: { x: 250, y: 200 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '4', data: { label: 'Virtualization & Containers' }, position: { x: 250, y: 300 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '5', data: { label: 'AWS Basics' }, position: { x: 250, y: 400 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '6', data: { label: 'Azure Basics' }, position: { x: 250, y: 500 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '7', data: { label: 'Google Cloud Basics' }, position: { x: 250, y: 600 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '8', data: { label: 'Cloud Security' }, position: { x: 250, y: 700 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '9', data: { label: 'DevOps & CI/CD' }, position: { x: 250, y: 800 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '10', data: { label: 'Serverless & Microservices' }, position: { x: 250, y: 900 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '11', data: { label: 'Monitoring & Logging' }, position: { x: 250, y: 1000 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '12', data: { label: 'Projects: Deploy Web Apps' }, position: { x: 250, y: 1100 }, style: { background: '#06b6d4', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { source: '1', target: '2', animated: true, style: { stroke: '#22d3ee' } },
      { source: '2', target: '3', animated: true, style: { stroke: '#22d3ee' } },
      { source: '3', target: '4', animated: true, style: { stroke: '#22d3ee' } },
      { source: '4', target: '5', animated: true, style: { stroke: '#22d3ee' } },
    ...
    // End Cloud
    Fullstack: [
      { id: '1', data: { label: 'Introduction to Fullstack' }, position: { x: 250, y: 0 }, style: { background: '#0ea5e9', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { id: '2', data: { label: 'HTML, CSS, JavaScript' }, position: { x: 250, y: 100 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '3', data: { label: 'Frontend Frameworks: React/Vue/Angular' }, position: { x: 250, y: 200 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '4', data: { label: 'Version Control: Git' }, position: { x: 250, y: 300 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '5', data: { label: 'Backend: Node.js/Express, Django, Flask' }, position: { x: 250, y: 400 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '6', data: { label: 'Databases: SQL & NoSQL' }, position: { x: 250, y: 500 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '7', data: { label: 'Authentication & Security' }, position: { x: 250, y: 600 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '8', data: { label: 'APIs: REST & GraphQL' }, position: { x: 250, y: 700 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '9', data: { label: 'DevOps & Deployment' }, position: { x: 250, y: 800 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '10', data: { label: 'Testing: Unit & Integration' }, position: { x: 250, y: 900 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '11', data: { label: 'Projects: Fullstack Apps' }, position: { x: 250, y: 1000 }, style: { background: '#06b6d4', color: '#fff', border: '1px solid #22d3ee', padding: 10 } },
      { source: '1', target: '2', animated: true, style: { stroke: '#22d3ee' } },
      { source: '2', target: '3', animated: true, style: { stroke: '#22d3ee' } },
      { source: '3', target: '4', animated: true, style: { stroke: '#22d3ee' } },
      { source: '4', target: '5', animated: true, style: { stroke: '#22d3ee' } },
    ...
    C: [
      ...
      // ...existing code for other roadmaps...
      { id: '3', data: { label: 'Operators' }, position: { x: 250, y: 200 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '4', data: { label: 'Control Structures' }, position: { x: 250, y: 300 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
      { id: '5', data: { label: 'Functions' }, position: { x: 250, y: 400 }, style: { background: '#1e293b', border: '1px solid #22d3ee', padding: 10, color: '#fff' } },
